...
const About = () => {
  ...
  <main className='max-w-screen-2xl mx-auto bg-gradient-to-r from-pink-300 to-black h-auto min-h-[100vh]  flex flex-col md:flex-row font-sans pt-6'>
    ...
    <div className='w-full md:w-[40%] pt-12 flex justify-center'>
      <div className='h-auto rounded-full  bg-gray-900 w-[350px] md:w-[450px] flex justify-center'>
        <Image
    ...
    <div className='w-full md:w-[60%] pt-8 pl-6 md:pl-10'>
      ...
      <Button className='bg-pink-800 mt-8 text-gray-300 font-bold sm:text-[17px] rounded-3xl py-6 hover:bg-pink-400 hover:border-pink-600 hover:border-2 w-full md:w-auto'>
        Explore More About
      </Button>
    </div>
  </main>
